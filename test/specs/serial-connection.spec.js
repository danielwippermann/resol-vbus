...
const { Connection, SerialConnection } = require('./resol-vbus');
    ...
    describe('constructor', () => {
        it('should have reasonable defaults', () => {
            ...
            expectOwnPropertyNamesToEqual(
                ...
                ['_events', '_eventsCount', '_maxListeners', '_readableState', '_writableState', 'allowHalfOpen'],
            );
