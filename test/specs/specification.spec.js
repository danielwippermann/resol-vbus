...
describe('Specification', () => {
    ...
    describe('.storeSpecificationData', () => {
        ...
        it('should work correctly without arguments', () => {
            ...
            expectOwnPropertyNamesToEqual(rawSpecData, ['filteredPacketFieldSpecs']);
    ...
    describe('#convertRawValue', () => {
            ...
            for (let index = 0; index < units.length; index++) {
                ...
                content.push(
                    "it('should convert from " +
                        JSON.stringify(sourceUnit.unitCode) +
                        ' to ' +
                        JSON.stringify(targetUnit.unitCode) +
                        "', function() {",
                );
                content.push(
                    "expectConversion(0, '" +
                        ...
                        "', '" +
                        targetUnit.unitCode +
                        "').closeTo(undefined, delta);",
                );
                content.push(
                    "expectConversion(1000000, '" +
                        sourceUnit.unitCode +
                        "', '" +
                        targetUnit.unitCode +
                        "').closeTo(undefined, delta);",
        ...
        const expectConversion = (rawValue, sourceUnitCode, targetUnitCode) => {
        ...
        const expectConversions = (rawValue, conversions) => {
            const spec = new Specification();
    ...
    describe('#setPacketFieldRawValues', () => {
        ...
        it.skip('should work for a value with many parts', () => {
            const spec = new Specification();
    ...
    describe('#getBlockTypeSectionsForHeaders', () => {
        ...
        it('should work correctly #2', () => {
            ...
            const expectedValues = [
                ...
                [
                    '01_0015_7721_10_0100_07_0E_28',
                    '01_8015_71B3_10_F8BB',
                    72,
                    104,
                    7,
                    14,
                    28,
                    '070e00000102030405060708090a0b0c0d0e0f101112131415161718191a1b1c',
                ],
            ];
    ...
    describe('#getBlockTypeFieldsForSections', () => {
        ...
        it('should work correctly #2', () => {
            ...
            const expectedValues = [
                [
                    '01_8015_F61F_10_D62F_01_0015_7721_10_0100_02_01_4_004_2_0',
                    0,
                    0,
                ...
                [
                    '01_8015_F61F_10_D62F_01_0015_7721_10_0100_02_01_4_006_2_0',
                    0,
                    1,
                ...
                [
                    '01_8015_F61F_10_D62F_01_0015_7721_10_0100_02_01_4_008_2_0',
                    0,
                    2,
                ...
                [
                    '01_8015_F61F_10_D62F_01_0015_7721_10_0100_02_01_4_010_2_0',
                    0,
                    3,
                ...
                [
                    '01_8015_6659_10_49D0_01_0015_7721_10_0100_02_0A_1_004_2_0',
                    3,
                    0,
                ...
                [
                    '01_8015_6659_10_49D0_01_0015_7721_10_0100_02_0A_1_006_2_0',
                    3,
                    1,
                    'Temperatur Speicher',
                    56.4,
