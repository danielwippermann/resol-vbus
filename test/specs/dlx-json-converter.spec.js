...
describe('DLxJsonConverter', () => {
    ...
    describe('readable stream', () => {
        ...
        it('should work correctly', async () => {
            ...
            const onHeaderSet = vi.fn((headerSet) => {
                outConv.convertHeaderSet(headerSet);
            });

            const buffers = [];

            const onData = vi.fn((chunk) => {
                buffers.push(chunk);
            });
        ...
        it('should work with extendFieldData set to a function', async () => {
            ...
            const extendFieldData = vi.fn((fieldData, packetField, packetInfo, packetFieldIndex, packetInfoIndex) => {
...
refJsonRecording1 = {
    ...
    headerset_stats: {
        headerset_count: 1,
        min_timestamp: 1388324664.805,
        max_timestamp: 1388324664.805,
    },
    headersets: [
        {
            timestamp: 1388324664.805,
            packets: [
                {
                    header_index: 0,
                    timestamp: 1388324664.771,
                    field_values: [
                        {
                            field_index: 0,
                            raw_value: 1044.08,
                ...
                {
                    header_index: 6,
                    timestamp: 1388324663.019,
                    field_values: [
                        {
                            field_index: 0,
                            raw_value: 13191441.0,
                            value: '13191441',
                        },
                        {
                            field_index: 1,
